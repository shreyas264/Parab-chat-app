...
const Sidebar = ({ setSelectedGroup }) => {
  ...
  const fetchGroups = async () => {
    try {
      ...
      const { data } = await axios.get("https://parab-chat-app-backend.onrender.com/api/groups", {
  ...
  const handleCreateGroup = async () => {
    try {
      ...
      await axios.post(
        ...
        "https://parab-chat-app-backend.onrender.com/api/groups",
  ...
  const handleJoinGroup = async (groupId) => {
    try {
      ...
      const token = userInfo.token;
      await axios.post(
        `https://parab-chat-app-backend.onrender.com/api/groups/${groupId}/join`,
  ...
  const handleLeaveGroup = async (groupId) => {
    try {
      ...
      await axios.post(
        ...
        `https://parab-chat-app-backend.onrender.com/api/groups/${groupId}/leave`,
